	...
	public function aviator_bet_history(string $game_id)
{
    ...
    $bets = DB::table('aviator_bet')->select('aviator_bet.id as id', 'aviator_bet.game_sr_num as game_sr_num', 
                'aviator_bet.amount as amount', 'aviator_bet.win as win', 
                'aviator_bet.created_at as datetime', 'users.u_id as username', 

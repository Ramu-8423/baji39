<div class="full_container">
               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img">
                            <img class="img-responsive" src="https://root.baji39.com/uploads/baajilogo.png" style="height:70px; width:100px;" alt="#" />
                            </div>
                        <div class="user_info">
                           <h6>Admin</h6>
             ...
             @includeIf('admin.body.aviator_sidebar')
              <!--  @includeIf('admin.body.dragon_sidebar')
				@includeIf('admin.body.andarbahar_sidebar')-->
					  ...
					  <li>
                        <a href="#apps-xy" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-history blue2_color"></i> <span>Bet History</span></a>
                ...
                <li><a href="{{route('all_bet_history',$itemm->id)}}"> <span>{{$itemm->name}}</span></a></li>
                    ...
                    <li><a href="{{route('banner')}}"><i class="fa fa-bolt blue1_color" aria-hidden="true"></i> <span> Activity & Banner</span></a></li> 
                    <!-- <li><a href="{{route('feedback')}}"><i class="fa fa-file blue1_color"></i> <span>FeedBack</span></a></li>-->
                     
                     <li><a href="{{route('salary.list')}}"><i class="fa fa-money blue1_color"></i> <span> Salary</span></a></li>
  ...
  <!--      </li>-->
        ...
        <li>
            ...
            <i class="fa fa-upload  green_color"></i><span> Payin</span></a>
        ...
        <li>
            <a href="#app21" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                <i class="fa fa-download  green_color"></i> <span> Withdrawal</span></a>
                <ul class="collapse list-unstyled" id="app21">
  ...
  <!--      <li><a href="{{route('change_password')}}"><i class="fa fa-warning red_color"></i> <span>Change Password</span></a></li>-->
        <li><a href="{{route('details.bank')}}"><i class="fa fa-university yellow_color"></i> <span>Admin Bank Details</span></a></li>
	   <li><a href="{{route('business_data')}}"><i class="fa fa-briefcase red_color"></i> <span>Business Settings</span></a></li>
        <li><a href="{{route('auth.logout')}}"><i class="fa fa-sign-out red_color"></i> <span>Logout</span></a></li>

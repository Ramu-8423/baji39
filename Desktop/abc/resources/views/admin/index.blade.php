       ...
       <div class="row column1">
          <div class="col-md-6 col-lg-3">
		    ...
		    <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_">
                <div class="couter_icon">
                   <div> 
                      <i class="fa fa-user-check green_color"></i>
                   </div>
                </div>
                <div class="counter_no">
                   <div>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                <div class="couter_icon">
                   <div> 
                      <i class="fa fa-chart-line green_color"></i>
                   </div>
                </div>
                <div class="counter_no">
                   <div>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                <div class="couter_icon">
                   <div> 
                      <i class="fa fa-coins red_color"></i>
                   </div>
                </div>
                <div class="counter_no">
                   <div>
       ...
       <div class="row column1">
            ...
            <div class="full counter_section margin_bottom_30">
               ...
               <div class="counter_no">
                  <div>
					  ...
					  <p class="total_no"> ৳ {{ number_format($users[0]->commissions, 2) }}</p>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div> 
                     <i class="fa fa-wallet blue1_color"></i>
                  </div>
               </div>
               <div class="counter_no">
                  <div>
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div> 
                     <i class="fa fa-money-bill-wave green_color"></i>
                  </div>
               </div>
               <div class="counter_no">
                  <div>
      ...
      <div class="row column1">
         ...
         <div class="col-md-6 col-lg-3">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div> 
                     <i class="fa fa-comments blue1_color"></i>
                  </div>
               </div>
               <div class="counter_no">
                  <div>
		   ...
		   <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                <div class="couter_icon">
                   <div> 
                      <i class="fa fa-gamepad yellow_color"></i>
                   </div>
                </div>
                <div class="counter_no">
                   <div>
		    ...
		    {{-- <div class="col-md-6 col-lg-3">
             <div class="full counter_section margin_bottom_30">
                ...
                <div class="counter_no">
                   <div>
                    <p class="total_no">{{$cTotalCoins}}</p>

                      <p class="head_couter">Zilli Coins</p>
                   </div>
                </div>
             </div>
          </div> --}}
